...
- 每次測驗將包含*2個*由助教指定的測驗頁面 (@test_page) 項目；測驗分數為這兩個頁面上的分數平均。
...
#table(
  columns: 3,
  [日期], [範圍], [附註],
  [11/25], [Python for beginners (1) - (4)], [(4 抽 2)],
  [12/09], [Python for beginners (5) - (8)], [(4 抽 2)],
  [12/23], [Python for beginners (9) - (12)], [(4 抽 2)],
  [01/06], [Python for beginners (13) - (16)], [(4 抽 2)],
)


每次測驗為30分鐘，包含以下流程：

- 說明與分發測驗回條，上面會有：測驗頁面 (@test_page) 編號、分數欄與簽名欄 (5分鐘)
- 上機考試 (20分鐘)
- 準備與緩衝時間 (5分鐘)
- 測驗開始預設為 15：00
- 測驗結束預設為 15：30
...
- *測驗中不能開啟測驗頁面 (@test_page) 以外的分頁或視窗*。以下為範例但不限於：
...
- 若發生#KEY2[任何違規事項將註記次數]，而且助教有權要求您當日課後至助教研究室重考。*設 $n$ 為學期總違規次數，小考總成績將扣 $n times 2^n$*。



== 請假與補考

- 因故無法參與考試，請在*考試3天前*寄信或找助教完成請假程序。聯絡方式詳見 @contact_ta。
- 未經請假而*缺席*，則當次測驗計為*零分*。
